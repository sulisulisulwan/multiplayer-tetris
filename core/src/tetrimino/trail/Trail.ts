...
import { QueueList } from "../../next-queue/QueueList.js"
...
class Trail {
  ...
  protected getTetriminoTopBorderCoords(tetrimino: Tetrimino): number[][] {
    const tetriminoCoords = (tetrimino.orientations as OrientationsMap)[tetrimino.currentOrientation as keyof OrientationsMap]
