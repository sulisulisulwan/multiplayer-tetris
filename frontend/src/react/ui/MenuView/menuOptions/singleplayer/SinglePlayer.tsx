        ...
        <div>
          ...
          <ul style={{
            ...
            <li style={{ textAlign: 'right' }}>
              <HoverButton
                onClick={() => { setAppState((currentState) => { return { ...currentState,  view: 'singleplayer_options'}}) }}
                style={{
                  textAlign: 'center',
                  cursor: 'pointer',
                  background: 'slategray',
            ...
            <li style={{ textAlign: 'center' }}>
              <HoverButton
                onClick={() => { setAppState((currentState) => { return { ...currentState,  view: 'singleplayer_highscore'}}) }}
                style={{
                  textAlign: 'center',
                  cursor: 'pointer',
                  background: 'slategray',
            ...
            <li style={{ textAlign: 'left' }}>
              <HoverButton
                onClick={() => { setAppState((currentState) => { return { ...currentState,  view: 'singleplayer_help'}}) }}
                style={{
                  textAlign: 'center',
                  cursor: 'pointer',
                  background: 'slategray',
          ...
          <div style={{ textAlign: 'center', marginTop: 50 }}>
            <HoverButton
              onClick={() => { setAppState((currentState: any) => { return { ...currentState, view: 'loadGame'}}) }}
              style={{ 
                padding: 20, 
                fontSize: 15, 
                fontWeight: 900, 
