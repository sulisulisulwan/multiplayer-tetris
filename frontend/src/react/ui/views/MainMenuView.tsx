...
import { setViewToMultiplayerMenu, setViewToSingleplayerMenu } from 'multiplayer-tetris-redux'
      ...
      <ul style={{
        ...
        <li style={{
          ...
          <HoverButton
            onClick={() => {
              ...
              dispatcher(setViewToSingleplayerMenu())
            }}
        ...
        <li>
          <HoverButton
            onClick={() => { 
              soundEffects.play('menuBasicButtonClick')
              dispatcher(setViewToMultiplayerMenu())
            }}
            onHover={() => soundEffects.play('menuBasicButtonHover')}
            style={{
              textAlign: 'center',
